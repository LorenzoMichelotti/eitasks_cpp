...
#endif
#include <examples/example_glfw_opengl3/TaskManager.h>
...
int main(int, char**)
{
...
#endif
    {
        ...
        taskmanager.TaskListPanel(show_task_list_window, show_task_details_window);
        taskmanager.TaskDetailsPanel(show_task_details_window);
